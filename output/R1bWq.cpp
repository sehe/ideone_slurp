...
namespace pro {
	...
	typedef char GameTile; // Just a typedef for 'char'

	// Simple Point Class
	// Holds the X and Y values of a 2D Object
	...
	// For controlling the Main Character
	struct GamePlayer
	{
		Point< int > Position;
		GameTile Tile;
	...
	// 1 is the code for a happy face - FIXME!
